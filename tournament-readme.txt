...
・箱庭トーナメントで修正された個所に関するご質問は
	「箱庭トーナメント連絡用掲示板」に
　http://espion.s7.xrea.com/tyotou/tournament/cgi/trees.cgi
...
　怪しい島は、青色ラインで表示されます。
　IPカットにチェックをすると、IPアドレスの最後の区切りの部分を無視して表示します。
...
　◇2003/10/28 11:00　　Ver.0.88　クロスサイトスクリプティング脆弱性対策
