...
# 箱庭トーナメント２
# 設定ファイル
# $Id: hako-ini.cgi,v 1.7 2004/11/03 11:01:20 gaba Exp $
...
$version			= "0.94";					# バージョン表記用（基本的に変更しないように！）
...
$HdevelopeTime	= 43200;	# 開発期間更新時間 # 2時間
$HfightTime		= 86400;	# 戦闘期間更新時間 # 24時間
$HinterTime		= 93600;	# 戦闘期間終了後の開発期間への移行までの時間
$HdeveRepCount	= 3;		# 予選・開発期間一回に更新するターン数(例えば３にするとまとめて３ターン進む)
