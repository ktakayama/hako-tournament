...
# 箱庭トーナメント２
# 設定ファイル
# $Id: hako-ini.cgi,v 1.3 2003/10/28 01:56:10 gaba Exp $
...
$version			= "0.88";					# バージョン表記用（基本的に変更しないように！）
...
$HunitTime		= 10800;	# 予選期間更新時間(3600秒＝1時間)
$HdevelopeTime	= 7200;		# 開発期間更新時間 # 2時間
$HfightTime		= 86400;	# 戦闘期間更新時間 # 12時間
$HinterTime		= 93600;	# 戦闘期間終了後の開発期間への移行までの時間
$HdeveRepCount	= 1;		# 予選・開発期間一回に更新するターン数(例えば３にするとまとめて３ターン進む)
